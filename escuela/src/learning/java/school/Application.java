...
import learning.java.school.model.*;

import java.io.IOException; //No se para que sirve y no se tira la excepcion en el metodo main

public class Application {

    public static void main(String[] args) throws IOException {
        Group groups[] = prepareOOPGroups();//Group [] groups = prepareOOPGroups();
    ...
    public static Group[] prepareOOPGroups() {
        Group groups[] = new Group[2]; // Group [] groups = new Group[2];
